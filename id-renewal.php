        ...
        <div class="row" style="margin-top: 35px">
            ...
            <div class="full">
              <div class="tab_bar_section">
                <ul class="nav nav-tabs" role="tablist">
                  ...
                  <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#reviews">Download Form</a> </li> 
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                  ...
                  <div id="reviews" class="tab-pane fade">
                    <div class="product_review">
                      <h3>You are about to download the form, Please follow the step-by-step instruction</h3>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="full review_bt_section">
                            <div class="float-left"> <a class="btn sqaure_bt" href="forms/ID-Renewal-Form.docx" download>Download Now</a><p>id-renewal-form.docx</p> </div>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <!-- <div class="col-md-6">
            <div class="full" style="margin-top: 35px;">
              ...
              <p><a class="btn main_bt" href="#">Download Form</a></p>
