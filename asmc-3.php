...
<?php 
$staticBannerTitle = "ASMC III";
include 'template/static-banner.php';
?>
      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h2>Advance Security Management Course III</h2>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="full margin_bottom_30">
              <div class="accordion border_circle">
                <div class="bs-example">
                  ...
                  <div class="blog_feature_img"> <img class="img-responsive" src="images/asmc-iii.png" alt="#"> </div><br>
                  <!-- <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><i class="fa fa-star" aria-hidden="true"></i> Subjects to be discussed<i class="fa fa-angle-down"></i></a> </p>
                      </div>
                      <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                          <p>
                            
                              <li>Physical Security Planning</li>
                              <li>Business Continuity Program</li>
                              <li>Introduction to Asset Protection</li>
                              <li>Managing Security Operations</li>
                              <li>Budget Preparation and Management</li>
                              <li>Risk Management</li>
                              <li>CCTV Operation and Management</li>
                              <li>How to present your Security Management Plan</li>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><i class="fa fa-plane"></i> Title<i class="fa fa-angle-down"></i></a> </p>
                      </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree"><i class="fa fa-star"></i> Title<i class="fa fa-angle-down"></i></a> </p>
                      </div>
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <p class="panel-title"> <a data-toggle="collapse" data-parent="#accordion" href="#collapseFour"><i class="fa fa-bar-chart" aria-hidden="true"></i> Title<i class="fa fa-angle-down"></i></a> </p>
                      </div>
...
<!--          <div class="col-md-6">
            <div class="full" style="margin-top: 35px;">
              ...
              <p><a class="btn main_bt" href="#">Button Dito</a></p>
            </div>
          </div> -->
        </div>
            ...
            <div class="full">
              <div class="tab_bar_section">
                <ul class="nav nav-tabs" role="tablist">
                  <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#description">Important Details</a> </li>
