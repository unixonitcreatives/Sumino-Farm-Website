      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h2>Advance Security Management Course I</h2>
          </div>
        </div>
      </div>
    </div>
		    ...
		    <div class="row" style="margin-top: 35px">
		      <div class="col-md-12">
		        <div class="full margin_bottom_30">
                  ...
                  <div class="blog_feature_img"> <img class="img-responsive" src="images/asmc-i.png" alt="#"> </div><br>
