      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_center">
            <h2>Advance Security Management Course II</h2>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="full margin_bottom_30">
              <div class="accordion border_circle">
                <div class="bs-example">
                  ...
                  <div class="blog_feature_img"> <img class="img-responsive" src="images/asmc-ii.png" alt="#"> </div><br>
